...
package im.heart.continew.member.auth.model.resp;
...
public class OnlineMemberResp implements Serializable {
    ...
    @AssembleMethod(prop = ":lastActiveTime", targetType = OnlineMemberService.class, method = @ContainerMethod(bindMethod = "getLastActiveTime", type = MappingType.ORDER_OF_KEYS))
