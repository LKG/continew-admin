 ...
 */
public interface MemberLogMapper extends BaseMapper<MemberLogDO> {
     ...
     * @return 分页列表信息
     */
    IPage<MemberLogResp> selectLogPage(@Param("page") IPage<MemberLogDO> page,
                                       @Param(Constants.WRAPPER) QueryWrapper<MemberLogDO> queryWrapper);
     ...
     * @return 列表信息
     */
    List<MemberLogResp> selectLogList(@Param(Constants.WRAPPER) QueryWrapper<MemberLogDO> queryWrapper);
