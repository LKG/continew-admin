...
public class FieldDetailResp extends BaseDetailResp {
    ...
    @ExcelProperty(value = "字段类型 1 单行文本 2 多行文本 3 单选 4日期 5 数字 6 小数 7 手机  8 文件 9 多选 10 人员 11 附件 12 部门 13 日期时间 14 邮箱 15客户 16 商机 17 联系人 18 地图 19 产品类型 20 合同 21 回款计划")
    ...
    @ExcelProperty(value = "标签 1 线索 2 客户 3 联系人 4 产品 5 商机 6 合同 7回款8.回款计划")
    ...
    @ExcelProperty(value = "是否唯一 1 是 0 否")
    ...
    @ExcelProperty(value = "是否隐藏  0不隐藏 1隐藏")
    ...
    @ExcelProperty(value = "字段来源  0.自定义 1.原始固定 2原始字段但值存在扩展表中")
    ...
    @ExcelProperty(value = "表单定位 坐标格式： 1,1")
