//package top.continew.admin.cms.generator;
//
//import org.springframework.beans.factory.annotation.Qualifier;
//import org.springframework.lang.Nullable;
//import org.springframework.scheduling.concurrent.ThreadPoolTaskExecutor;
//import org.springframework.stereotype.Component;
//import top.continew.admin.cms.model.entity.ArticleDO;
//import top.continew.admin.cms.service.ArticleService;
//import top.continew.admin.cms.service.ChannelService;
//import top.continew.admin.cms.service.TaskService;
//
//import java.util.*;
...
//                                         Collection<ArticleDO> articleList, @Nullable Long origChannelId) {
//        Set<ArticleDO> articles = new HashSet<>(articleList.size());
//        for (ArticleDO article : articleList) {
//            Long articleId = article.getId();
//            Long channelId = article.getChannelId();
//            Integer order = article.getSort();
//            // 当前文章直接更新，以免导致 404错误
//            Optional.ofNullable(articleService.get(articleId))
